...
<body>
    ...
    <div class="easyui-layout" style="width: 99.9%;height:100%; ">
        <%--  头部区域--%>
        <div region="north" split="true" style="height: 125px; width:100%; position: relative;display:block ">
            ...
            <div style="color: #0070b8; font-family: Georgia,Serif; font-weight: bolder; position: absolute; right: 10px; bottom: 10px; z-index: 10;">
                <span id="Timer"></span>【<%=Session["角色"]%>:<%=Session["用户名"]%>】
            </div>
        </div>
        <%--左边菜单区域--%>
        <div region="west" split="true" title="菜单" style="width: 270px;/*height:1800px;*/ padding: 10px 20px;">
