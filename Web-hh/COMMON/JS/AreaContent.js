...
dsy.add("0_0_0",["合肥","安庆","蚌埠","巢湖","池州","滁州","阜阳","淮北","淮南","黄山","六安","马鞍山","宿州","铜陵","芜湖","宣城","亳州"]); 
dsy.add("0_0_1",["北京"]); 
dsy.add("0_0_2",["福州","龙岩","南平","宁德","莆田","泉州","三明","厦门","漳州"]); 
dsy.add("0_0_3",["兰州","白银","定西","甘南藏族自治州","嘉峪关","金昌","酒泉","临夏回族自治州","陇南","平凉","庆阳","天水","武威","张掖"]); 
dsy.add("0_0_4",["广州","深圳","潮州","东莞","佛山","河源","惠州","江门","揭阳","茂名","梅州","清远","汕头","汕尾","韶关","阳江","云浮","湛江","肇庆","中山","珠海"]); 
dsy.add("0_0_5",["南宁","百色","北海","崇左","防城港","桂林","贵港","河池","贺州","来宾","柳州","钦州","梧州","玉林"]); 
dsy.add("0_0_6",["贵阳","安顺","毕节","六盘水","黔东南苗族侗族自治州","黔南布依族苗族自治州","黔西南布依族苗族自治州","铜仁","遵义"]); 
dsy.add("0_0_7",["海口","白沙黎族自治县","保亭黎族苗族自治县","昌江黎族自治县","澄迈县","定安县","东方","乐东黎族自治县","临高县","陵水黎族自治县","琼海","琼中黎族苗族自治县","三亚","屯昌县","万宁","文昌","五指山","儋州"]); 
dsy.add("0_0_8",["石家庄","保定","沧州","承德","邯郸","衡水","廊坊","秦皇岛","唐山","邢台","张家口"]); 
dsy.add("0_0_9",["郑州","安阳","鹤壁","济源","焦作","开封","洛阳","南阳","平顶山","三门峡","商丘","新乡","信阳","许昌","周口","驻马店","漯河","濮阳"]); 
dsy.add("0_0_10",["哈尔滨","大庆","大兴安岭","鹤岗","黑河","鸡西","佳木斯","牡丹江","七台河","齐齐哈尔","双鸭山","绥化","伊春"]); 
dsy.add("0_0_11",["武汉","鄂州","恩施土家族苗族自治州","黄冈","黄石","荆门","荆州","潜江","神农架林区","十堰","随州","天门","仙桃","咸宁","襄樊","孝感","宜昌"]); 
dsy.add("0_0_12",["长沙","常德","郴州","衡阳","怀化","娄底","邵阳","湘潭","湘西土家族苗族自治州","益阳","永州","岳阳","张家界","株洲"]); 
...
dsy.add("0_16",["阿布鲁佐 Abruzzi","巴西利卡塔 Basilicata","卡拉布里亚 Calabria","坎帕尼亚 Campania","艾米利亚－罗马涅 Emilia-Romagna","弗留利－威尼斯·朱利亚* Friuli-Venezia Giulia","拉齐奥 Lazio","利古里亚 Liguria","伦巴第 Lombardia","马尔凯 Marche","莫利塞 Molise","皮埃蒙特 Piemonte","普利亚 Puglia","撒丁* Sardegna","西西里* Sicilia","托斯卡纳 Toscana","特伦蒂诺-上阿迪杰* Trentino-Alto Adige","翁布里亚 Umbria","瓦莱·达奥斯塔* Valle d'Aosta","威尼托 V.Neto"]); 
...
dsy.add("0_17_0",["阿尔汉格尔斯克州 Archangel'sk Obl.","涅涅茨自治区 N.Netskiy AOK","圣彼得堡市 Gorod Sankt-Peterburg","加里宁格勒州 Kaliningrad Obl.","卡累利阿共和国 Karelija ARep.","科米共和国 Komi ARep.","列宁格勒州 Leningrad Obl.","摩尔曼斯克州 Murmansk Obl.","诺夫哥罗德州 Novgorod Obl.","普斯科夫州 Pskov Obl.","沃洛格达州 Vologda Obl."]); 
...
dsy.add("0_17_4",["车里雅宾斯克州 Cel'abinsk Obl.","库尔干州 Kurgan Obl.","斯维尔德洛夫斯克州 Sverdlovsk Obl.","秋明州 T'umen' Obl.","汉特－曼西自治区 Khanty-Mansiyskiy AOK","亚马尔－涅涅茨自治区 Yamalo-N.Netskiy AOK"]); 
